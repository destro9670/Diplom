...
/**
 * Created by destr on 02.04.2020.
 */
public class Cripto extends Assert {
    ...
    private static final DeviseInfo.test t = new DeviseInfo.test();
        ...
        try {
            ...
            switch (jsResponce2.getString("alghorytm")){
                case "Strumock":
                    ...
                    String decriptedMsg = new String(cripography.decript(msg.getBytes()),StandardCharsets.UTF_8);
